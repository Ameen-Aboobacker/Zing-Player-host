            ...
            IconButton(
                onPressed: () async {
                  if (GetAllSongController.audioPlayer.hasPrevious) {
                    //add recent
                    GetRecentSong.addRecentlyPlayed(GetAllSongController
                        .playingSong[
                            GetAllSongController.audioPlayer.currentIndex! - 1]
                        .id);
    
                    // add mostly
                    GetMostlyPlayed.addmostlyPlayed(GetAllSongController
                        .playingSong[
                            GetAllSongController.audioPlayer.currentIndex! - 1]
                        .id);
